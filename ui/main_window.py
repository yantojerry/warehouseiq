...
from ui.settings import apply_saved_super_admin_preferences, apply_saved_user_preferences
from ui.styles import canonical_role, display_role, make_badge, repolish
from backend.auth.roles import ROLE_ADMIN, is_super_admin
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, username=None, role=None, display_name=None, permissions=None, low_stock_count=0):
        ...
        if self._is_super_admin:
            apply_saved_super_admin_preferences()
        else:
    ...
    def _brand_header(self):
        ...
        self.brand_text.setObjectName("transparent_cell")
        ...
        toggle.setIcon(icon("fa5s.bars", COLORS["muted"]))
    ...
    def _profile_card(self):
        ...
        self.profile_text.setObjectName("transparent_cell")
    ...
    def _populate_nav(self):
        ...
        if self._is_super_admin or self.role == ROLE_ADMIN:
